...
class CreateContentPageContentTagPivotTable extends Migration
{
    public function up()
    {
        Schema::create('content_page_content_tag', function (Blueprint $table) {
            ...
            $table->foreign('content_page_id', 'content_page_id_fk_170137')->references('id')->on('content_pages');
            $table->unsignedInteger('content_tag_id');
            $table->foreign('content_tag_id', 'content_tag_id_fk_170137')->references('id')->on('content_tags');
        });
    }
}
