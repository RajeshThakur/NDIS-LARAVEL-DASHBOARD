...
class CreateBookingCheckinsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('booking_checkins', function (Blueprint $table) {
            ...
            $table->boolean('participant_checkin')->default(0);
            $table->dateTime('participant_checkin_time')->nullable();
            $table->string('participant_lat')->nullable();
            $table->string('participant_lng')->nullable();

            $table->boolean('sw_checkin')->default(0);
            $table->dateTime('sw_checkin_time')->nullable();
