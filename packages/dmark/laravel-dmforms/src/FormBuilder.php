                            ...
                            '<div class="'.$fileAttr['thumb_col_class'].'">' .
                                '<div class="filupp-img">' .
                                    '<div class="'.$fileAttr['thumb_wrapper_class'].'">' .
                                        '<span class="profileImage size-60 img-circle profile-image '.$fileAttr['thumb_class'].'" id="'.$fileAttr['thumb_id'].'" style="background-image: url('.$imgThumb.')" ></span>' .
                                    '</div>' .
                                '</div>' .
                            '</div>' .
            ...
            <script>
                window.onload = function() {
                    jQuery("#file-<?php echo $inputAttr['id']?>").change(function(ev){
                        ...
                        if( $.trim($("#file-<?php echo $inputAttr['id']?>").val()) !== "" ){
                            var reader = new FileReader();
                            reader.onload = function (e) {
                                jQuery('#<?php echo $fileAttr['thumb_id']?>').css('background-image', 'url(' + e.target.result + ')');
                            }
                            ...
                            jQuery('#<?php echo $fileAttr['button_id']?>').prop("disabled", "disabled");
                        }
