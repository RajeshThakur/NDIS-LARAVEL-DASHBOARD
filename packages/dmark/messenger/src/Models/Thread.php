...
class Thread extends Eloquent
{
    ...
    {
        $this->table = Models::table('message_thread');
    ...
    {
        return $this->belongsToMany(Models::classname('User'), Models::table('message_participants'), 'thread_id', 'user_id');
    }
    ...
    {
        $participantsTable = Models::table('message_participants');
        $threadsTable = Models::table('message_thread');
    ...
    {
        $participantTable = Models::table('message_participants');
        $threadsTable = Models::table('message_thread');
