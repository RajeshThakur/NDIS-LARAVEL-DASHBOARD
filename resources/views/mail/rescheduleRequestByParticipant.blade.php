  ...
  <body>
    ...
    <div class="table-email">
        <div class="table-custom-email">
            ...
            <p>Participant {{ $participant->getName() }} of the Service Booking have requested to reschedule the service booking.</p>
            ...
            <p>You can approve or decline the request using {{config('app.name')}} mobile app. </p>
