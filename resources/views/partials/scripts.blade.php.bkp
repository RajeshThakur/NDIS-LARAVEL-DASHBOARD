...
<script src="{{ asset('assets/bootstrap-4.2.1/js/bootstrap.js') }}"></script>
...
<script src="{{ asset('assets/datetimepicker/datetimepicker.min.js') }}"></script>
<script src="{{ asset('assets/daterangepicker/daterangepicker.js') }}"></script>
<script src="{{ asset('assets/ckeditor5/11.0.1/ckeditor.js') }}"></script>
