...
@section('bottom')
    ...
    <div id="onboardingForms">
            ...
            @include( 'admin.serviceProviders.popups.step1' )
            @include( 'admin.serviceProviders.popups.step2' )
    ...
    <script>
        $(function () {
            ...
            if(!is_popup_closed){
                ...
                var current_step = {{$serviceProvider->onboarding_step}};
                ...
                // Validate Steps
                ndis.ajax(
                    '{{ route("admin.provider.onboarding.validate") }}',
                    'POST',
                    {
