...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.cms.pages.update", [$contentPage->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
        ...
        @can('participant_delete')
                @include('template.deleteItem', [ 'destroyUrl' =>  route("admin.cms.pages.destroy", [$contentPage->id]) ])
        @endcan
