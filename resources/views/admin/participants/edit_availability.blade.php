<form action="{{ route("admin.participants.availability", [$participant->user_id]) }}" method="POST" id="avaibilityForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <div class="table-responsive participant-availability form-mt">
                ...
                <div class="creat-new-avaibility mt-40">
                    {!! 
                        // Form::button( trans('participants.add_availability') )->id("saveAvailability")->attrs(["class"=>"btn btn-sucess rounded plr-100"]) 
                        Form::button( trans('participants.add_availability') )->id("addAvailability")->attrs(["class"=>"btn btn-sucess rounded plr-100"]) 
                    !!}
                </div>
            </div>
        </div>
