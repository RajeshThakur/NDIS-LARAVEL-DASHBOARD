                  ...
                  <div class="parties-section">
                     ...
                     <fieldset class="mb-5">
                        ...
                        <div class="responsible-section new-form-agreement">
                           <div class="form-group">
                              <h4>As a provider, <strong>{!! isset($provider->provider->business_name) ? $provider->provider->business_name : '' !!}</strong>  agrees to supply the following supports (Click the arrow and select all the appropriate registration group for this Participant)</h4>
                           </div>
                           <span class="count_selected_options dashb-count"></span>
                           ...
                           <div class="form-group">
                              <h4>Select the Supports that you will be providing (Click the arrow to select the Supports to be provided to this Participant)</h4>
                           </div>
                           <span class="childitems_count_selected_options  dashb-count"></span>
                           <div class="form-group {{ $errors->has('childitems') ? 'has-error' : '' }}">
                              ...
                              @if($errors->has('childitems'))
                                 <em class="invalid-feedback">
                                    {{ $errors->first('childitems') }}
                                 </em>
                              @endif
                              <p class="helper-block">
                                 {{ trans('cruds.contentPage.fields.category_helper') }}
                           ...
                           <div class="responsible-section2 last-new-agreement">
                              ...
                              <div class="support_table">          
                                 <div class="row ">
                                    <div class="col-sm-4">
                                       <div class="form-group">
                                          <label><strong>{!! 'Total Funding'!!}   –</label></strong>
                                       </div>
                                    </div>
                                    <div class="col-sm-6">
                                       <!-- {!! 
                                       ...
                                       ->size('col-sm-12')
                                       ->hideLabel()
                                       ->placeholder('Fill your total funding available')
                                       !!} -->
                                       <div class="total-input-plac">
                                          <div class="input-group">
                                             <input type="text" name="budget_funding" id="inp-budget_funding" class="form-control form-control-col-sm-12" placeholder="Fill your total funding available" required="required" >
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="new-agreement-table ">
                                    <table class="table-responsible table-1 text-center responsive" id="reg_budget">
                                       ...
                                       <tbody>
                                          <tr>
                                             <td colspan="">Please Select Registration Groups Above</td>
                                          </tr>
                                       </tbody>
                                    </table>
                                 </div>
                     ...
                     <fieldset class="responsibilite2 mb-5">
                        ...
                        <div class="filling-agreement-form-below">
                           ...
                           <div class="row ">
                              <div class="label col-sm-4">
                                 <div class="form-group">
                                    <label>Signature of {{$participant->getName()}}</label>
                                 </div>
                              </div>
                              <div class="label col-sm-8">
                           ...
                           <div class="row ">
                              <div class="label col-sm-4">
                                 <div class="form-group">
                                 <label>Signature on behalf of {{$provider->getName()}}</label>
                                 </div>
                              </div>
                              <div class="label col-sm-8">
