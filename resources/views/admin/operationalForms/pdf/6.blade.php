...
<style>
   ...
   <div class="card-body" style="font-family: 'Open Sans', sans-serif; border:1px solid #777d; padding:15px;">
      <div class="operational-form-design custom-table-pdf">
         ...
         <form action="{{ route($formAction[0],$formAction[1]) }}" method="POST" class="validated" enctype="multipart/form-data">
            ...
            <div class="card-header">
               <h2 style="text-align:center;">Client Referral Form</h2>
            </div>
            ...
            <table>
               <tbody>
                  <tr>
                     <td style="background:none; padding-right:220px;">
                  ...
                  <tr>
                     ...
                     <td style="text-align:right;">
                        {!!valOrAlt( $meta, 'email', $participant, 'email' )!!}
                     </td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td style="text-align:right;">
                        {!!valOrAlt( $meta, 'phone', $participant, 'phone' )!!}
                     </td>
                  </tr>
                  <tr>
                     <td style="background:none;">
                     ...
                     <td style="text-align:right;">
                        {!!isset($meta['dateofbirth']) ? $meta['dateofbirth'] : date('d-m-Y')!!}
                     </td>
                  </tr>
                  <tr>
                     <td style="background:none;">
                  ...
                  <tr>
                     ...
                     <td style="text-align:right;">
                        {!!issetKey( $meta, 'present_situation', '' )!!}
                     </td>
                  </tr>
                  <tr>
                     <td style="background:none;">
                     ...
                     <td style="text-align:right;">
                        {!!issetKey( $meta, 'identified_needs', '' )!!}
                     </td>
                  </tr>
                  <tr>
                     <td style="background:none;">
                  ...
                  <tr>
                     ...
                     <td style="text-align:right;">
                        {!!issetKey( $meta, 'client_referrer_name', '' )!!}
                     </td>
                  </tr>
                  <tr>
                     <td style="background:none;">
