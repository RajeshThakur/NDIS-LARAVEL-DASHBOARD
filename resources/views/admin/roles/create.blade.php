...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.roles.store") }}" method="POST" class="validated" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('permissions') ? 'has-error' : '' }}">
                ...
                <select required="required" data-rule="required" data-msg-required="Permissions are required" name="permissions[]" id="permissions" class="form-control select2" multiple="multiple">
