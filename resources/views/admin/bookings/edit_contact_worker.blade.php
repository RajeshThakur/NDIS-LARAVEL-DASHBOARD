...
<div class="participant-document form-mt">
                    ...
                    <tbody>
                        ...
                        @else
                            <tr>
                                <td width="10" class="select-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 10px;" aria-label=""></td>
                                <td colspan="4">
                                    No Messages For Support Workers Yet!
                                </td>
                                <td width="10" class="select-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 10px;" aria-label=""></td>
                            </tr>
                        @endif
    ...
    <div id="newMsgForm" style="display:none;">
        ...
        <form action="{{ route("admin.bookings.edit.contact.worker.save", [$booking->order_id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="booking-document form-mt">
                <div class="row">
                    {!! 
                        Form::text('subject',  'Subject', old('subject') )->placeholder('Subject')
                    !!}
