                    ...
                    @if($records->count())
                        @foreach($records as $key => $timesheet)
                            ...
                            <tr data-entry-id="{{ $timesheet->id }}">
                                ...
                                <td>
                                    {{ ucfirst($timesheet->booking_type) }}
                                </td>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="booking_status[]" value="{{ $timesheet->booking_order_id }}" />
                                </td>
...
@if($records->count()  > 0)
    {!! 
        Form::submit('Submit')->attrs(["class"=>"btn btn-primary rounded"]) 
    !!}
@endif
