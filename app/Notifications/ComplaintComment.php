...
class ComplaintComment extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                ->subject('['.config('app.name').'] New comment has been added to complaint!')
                ->view('mail.complaintComment', ['bookingOrder' => $this->bookingOrder, 'notifiable' => $notifiable]);
                // ->greeting(sprintf('Hi %s,', $notifiable->getName() ))
                // ->line('A new comment has been added to the complaint involving service booking.')
    ...
    public function toDatabase($notifiable)
    {
        return [
            ...
            'text'=>"A comment on Service Booking Complaint has been made!",
            'details'=>"A new comment on the service booking complaint has been made. You can view the comment on Complaint page."
        ];
    }
    ...
    public function toMobile($notifiable){
        if($notifiable->push_token){
            \OneSignal::sendNotificationToUser(
                "A comment on Service Booking Complaint has been made!",
