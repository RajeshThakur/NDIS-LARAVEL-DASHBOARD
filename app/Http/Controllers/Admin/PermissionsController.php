...
class PermissionsController extends Controller
{
    ...
    public function store(StorePermissionRequest $request)
    {
        ...
        return redirect()->route('admin.permissions.index')->with('success', trans('msg.permissions_create.success') );
    }
    ...
    public function update(UpdatePermissionRequest $request, Permission $permission)
    {
        ...
        return redirect()->route('admin.permissions.index')->with('success', trans('msg.permissions_update.success') );
    }
