...
class StoreRegistrationGroupRequest extends FormRequest
{
    public function authorize()
    {
        
        return \Gate::allows('registration_group_create');
    }
    ...
    {
        return [
            'title.required' => trans('errors.registration_group_create.title'),
            ...
            'status.required' => trans('errors.registration_group_create.status'),
        ];
    }
